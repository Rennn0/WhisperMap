...
<template>
    <article role="button" tabindex="0" :aria-label="`Open ${props.product.title}`"
        class="group flex h-full cursor-pointer flex-col overflow-hidden rounded-2xl border border-subtle bg-surface transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md min-h-88 md:min-h-80"
