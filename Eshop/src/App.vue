...
<template>
  ...
  <div v-else class="flex items-center justify-center min-h-screen" role="status" aria-label="Loading">
    <TablerLoaderBlockWave class="w-16 md:w-28 lg:w-44 h-16 md:h-28 lg:h-44" aria-hidden="true" />
  </div>
</template>