...
internal class GetProductCartCookieHandler : IProductCartHandler
{
    ...
    /// <summary>
    /// </summary>
    public GetProductCartCookieHandler(
    ...
    /// <inheritdoc />
    public ValueTask<ApiContract> HandleAsync(
        AddProductInCartContext context,
    ...
    )
    {
        ...
        AddProductInCartContract contract = new AddProductInCartContract(
            true,
    ...
    {
        ApiContract contract = await _getProductsHandler.HandleAsync(
            new GetProductsContext(Ids: GetProductIdsFromCookies()),
            cancellationToken
        );
    ...
    public bool ExistsInCart(Product product) =>
        GetProductIdsFromCookies().Any(id => product.Id == id);
